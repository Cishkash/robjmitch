...
My personal site. Bootstrapped with the `create-react-app` there were a lot of modifications post [ejection](#npm-run-eject).
So leaving the `create-react-app` README below in case anyone may be unfamiliar with it. Just note it all may not apply!
